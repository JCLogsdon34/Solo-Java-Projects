DROP DATABASE IF EXISTS bookreviewplatformtests;

CREATE DATABASE bookreviewplatformtests;

USE bookreviewplatformtests;

CREATE TABLE IF NOT EXISTS bookreviewplatformtests.fields (
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests.authors (
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests.books (
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests.book_author (
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests.book_field (
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests.articles (
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests.article_author (
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests.article_field (
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests.reviews (
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests.bookreviews (
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests.articlereviews(
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests.review_bookreview (
...
CREATE TABLE IF NOT EXISTS bookreviewplatformtests. review_articlereview (
